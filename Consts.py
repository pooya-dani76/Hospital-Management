...
Show All Patients:
بازگرداندن لیست به حالت دیفالت(کارایی ای دکمه بعد از اتمام عملیات جستجو می باشد)
...
با فشردن کلید Done عملیات جستجو را آغاز کنید
...
DrugPageHelp = '''
 بصورت پیشفرض همه دارو های موجود در بیمارستان در لیست نمایش داده می شوند و با دابل کلیک کردن روی هر دارو اطلاعات آن را مشاهده کنید
...
Stock:
موجودی انبار (نباید خالی یا شامل حروف باشدهمچنین نمیتواند منفی باشد)
در اپدیت دارو نمیتوان مستقیما به این ویژگی دسترسی داشت.
.با دکمه های خرید یا فروش میتوانید موجودی انبار را تغییر دهید
ابتدا تعداد را در ورودی مربوطه وارد کرده و یکی از دکمه های buy(خرید) یا sell(فروش) را فشار دهید
